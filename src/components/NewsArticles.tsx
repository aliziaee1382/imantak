...
export default function NewsArticles({ lang }: NewsArticlesProps) {
  ...
  const categories = useMemo(() => {
    const cats = new Set(ARTICLES_DATA.map(a => lang === 'fa' ? a.category : a.categoryEn));
            ...
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
              ...
              >
                ...
                <div className="p-6 sm:p-10 space-y-6 max-h-[70vh] overflow-y-auto">
                  ...
                  {/* Body Text */}
                  <div className="text-zinc-700 dark:text-zinc-300 text-sm sm:text-base leading-relaxed space-y-4 whitespace-pre-wrap font-medium">
